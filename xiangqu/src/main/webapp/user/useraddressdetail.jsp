...
<div style="float:left;width:65px;height:100%;"></div><input type="text" style="width:150px;" required="required" name="address" value="${useraddress.address }">
</div>
...
<input type="submit" onclick="return checkvalue()" style="width: 73%; height: 32px; line-height: 32px; margin: 0 auto; text-align: center; background: #00d1bc; color: #fff; border-radius: 16px;" value="保存收货地址"></input>
</div>
</form>
