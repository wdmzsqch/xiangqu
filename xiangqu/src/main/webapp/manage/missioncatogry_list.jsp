...
function editorcatogry(id){
	window.location.href = "./editorcatogry?id="+id;
}
	...
	<div class="main-wrap">
		...
		<div class="crumb-wrap">
			<div class="crumb-list">
				<i class="icon-font"></i><a href="./home_page">首页</a><span class="crumb-step">&gt;</span>任务类型列表
			</div>
		</div>

		<div class="result-wrap">
			<form name="myform" id="myform" action="./missioncatogry_list" method="post">
				<div class="result-title">
					<div class="result-list">
						<input class="btn btn-primary btn2" name="creat_task" value="创建任务类型" type="button" onclick="editorcatogry(0)">
					</div>
				</div>
				<div class="result-content">
					<table class="result-tab" width="100%">
						...
						<c:forEach items="${missioncatogrylist }" var = "p">
						<tr>
							<td>${p.name}</td>
							<td><a class="link-update" href="./editorcatogry?id=${p.id }">修改</a> <a class="link-del" onclick="delindustry(${p.id })" style="cursor: pointer;">删除</a></td>
						</tr>
						</c:forEach>
					</table>
