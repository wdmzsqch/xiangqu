	...
	<div class="main-wrap">
		...
		<div class="crumb-wrap">
			<div class="crumb-list">
				<i class="icon-font"></i><a href="./home_page">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">文章管理</span>
			</div>
		</div>
		<form action="./article_list" method="post" name="pageForm" id="pageForm">
			...
			<div class="result-wrap">
				...
				<div class="result-content">
					<table class="result-tab" width="100%">
						...
						<c:forEach items="${article_list}" var="p">
							<tr>
								<td class="tc">${p.title}</td>
								<td>${webRootUrl}user/article?id=${p.id }</td>
								<td><a class="link-del" href="./article_detail?id=${p.id}">查看详情</a>
								</td>
							</tr>
						</c:forEach>
