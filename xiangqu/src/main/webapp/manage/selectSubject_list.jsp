...
<body>
	...
	<div class="main-wrap">
		...
		<form action="./selectSubject" method="post" name="pageForm" id="pageForm">
					...
					<table class="result-tab" width="100%">
						...
						<c:forEach items="${subject_list}" var="subject">
							<tr>
								...
								<td><fmt:formatDate value="${subject.addTime }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
								<td><a class="link-del" href="./chooseActivity?relatived_id=${subject.id}">选择</a>
								</td>
							</tr>
						</c:forEach>
