	...
	<div class="main-wrap">
		...
		<div class="crumb-wrap">
			<div class="crumb-list">
				<i class="icon-font"></i> <a href="./home_page">首页</a> <span class="crumb-step">&gt;</span> <a class="crumb-name" href="./industry_list">太原广告点位管理</a> <span
		...
		<div class="result-wrap">
			<div class="result-content">
				<form action="./ad_point_edit" method="post" id="myform" name="myform" enctype="multipart/form-data">
					...
					<input id="areatype" name="areatype" value="1" type="hidden">
