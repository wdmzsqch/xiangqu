...
function makepointmap(markid){
	window.location.href = "./make_mark_point_map?markid="+markid+"&areatype=1";
}

function add_ad_point(markid){
	window.location.href = "./select_mark_ad_point?markid="+markid+"&areatype=1";
}
</script>
</head>
<body>
	...
	<div class="main-wrap">
		...
		<form action="./mark_ad_point_list_taiyuan" method="post" name="pageForm" id="pageForm">
