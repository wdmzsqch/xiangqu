...
function setMarkSoloPoint(id,array, index){
	if(index == 20){
		...
		$.ajax({
			...
			data: {ids :id, longitude :longitude, latitude :latitude, areatype :0},
			success: function(msg){
				var data = eval("("+msg+")");
				var list = data.list;
				var returnlongitude = data.returnlongitude;
...
function makeactionpointmap(){
	window.location.href="./make_action_point_map?areatype=0";
}

function markactionpoint(id){
	window.location.href="./make_action_point_map?id="+id+"&areatype=0";
}
</script>
</head>
<body>
	...
	<div class="main-wrap">
		...
		<input type="hidden" value="0" name="areatype" id="areatype"/>
